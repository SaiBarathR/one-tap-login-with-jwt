...
export default function ButtonRenderer({ className, loading = false, text, imgSrc, onClickAction, ...additionalProps }) {
    return (
        <Button className={`bg-[#008DFF] text-white min-h-7 flex justify-center items-center gap-2 rounded-xl px-2 py-1 hover:scale-105 transition ease-in-out delay-75 ${className}`}
